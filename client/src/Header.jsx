      ...
      <div>
        <header className="flex justify-between ">
          <Link to={"/"} className="flex items-center gap-1">
            ...
            <span className="font-bold text-xl">Flyers</span>
          </Link>
          <div className="flex border border-gray-300 rounded-full pl-6 py-2 pr-2 gap-2 shadow-md shadow-gray-300">
            <div>Anywhere</div>
          ...
          >
            ...
            <div className="bg-gray-500 rounded-full border border-gray-500 text-white ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
