export default function Perks({ selected, onChange }) {
  ...
  return (
    <>
      <div className="mb-3">
        <h5 className="text-2xl">Perks</h5>
        <p className="text-gray-500 text-sm">Select what perks you have. </p>
        <div className="mt-2 grid grid-cols-2 md:grid-cols-4 lg:grid-clos-6 gap-2">
          <label className="flex gap-1 p-4 border border-gray-400 rounded-2xl items-center">
            {" "}
          ...
          <label className="items-center flex gap-1 p-4 border border-gray-400 rounded-2xl items-center">
            {" "}
            <input type="checkbox" onChange={handleCbClick} name="library" />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
